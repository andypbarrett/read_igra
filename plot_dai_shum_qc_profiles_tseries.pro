...
PRO PLOT_DAI_SHUM_QC_PROFILES_TSERIES_BATCH
  ...
  suffix = '.shum.00h.qc.tseries.png'

  FOR istat=0, nstat-1 DO BEGIN

     PLOT_DAI_SHUM_QC_PROFILES_TSERIES, station[istat].station_number, OBS_HOUR_ID=0
...
PRO PLOT_DAI_SHUM_QC_PROFILES_TSERIES, STATION, OBS_HOUR_ID=OBS_HOUR_ID

  obs_hour_id = N_ELEMENTS( OBS_HOUR_ID ) EQ 0 ? 0 : obs_hour_id

  fileName = station+'.month.shum.qc.nc'
